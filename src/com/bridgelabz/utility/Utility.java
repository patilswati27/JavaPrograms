...
/**
 * @param no
 * Determine head or tail
 */
public static void flipCoin(int no) {
	int headcount=0;// TODO Auto-generated method stub
	int tailcount=0;
	for(int i=0;i<=no;i++) {
	 if(Math.random()<0.5) {
 ...
 * @returnSystem.out.println("Enter the username");
 */
 ...
 * @param goal
 * @param trials is no of attempts
...
/**
     ...
     * @param str string to calculate permutation using recursive approach for 
 ...
 * @param n
 */
public static String permutation( char[] array,int size,int n) {
 if(size==1) {
